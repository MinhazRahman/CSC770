...
int main(int argc, char *argv[])
{
    ...
    if (!mypid)
    {
        ...
        // multiply matrix-vector row-wise
        // The tasks involve the dot product of one row of the matrix with the vector
        // Each iteration computes one element of the result_vector[n]
        for (int i = 0; i < matrix_rows; i++)
        {
            result_vector[i] = 0.0;
            for (int j = 0; j < matrix_cols; j++)
